...
export default function Home() {
  ...
  return (
    <div className="min-h-screen  w-screen bg-gradient-to-r from-blue-800 from-10% via-blue-500 via-30% to-blue-950 to-90% ">
      <div className="fixed inset-x-0 bottom-0 z-50 text-center justify-center items-center  pt-4  pb-6 bg-gradient-to-r from-blue-800 from-10% via-blue-500 via-30% to-blue-950 to-90%">
